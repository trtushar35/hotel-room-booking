...
<aside class="profile-card">
  <header>
    ...
    <img style="border-radius: 50%;" height="150" width="150" src="{{url('uploads/users',$user_id->image)}}" alt="">
  ...
  <body>
  <a href="{{route('user.list')}}" style="border:1px solid black; text-decoration: none; padding:10px; margin-top:20px;background-color:#FF5722;margin-left:110px"><b>Back</b></a>
  </body>
